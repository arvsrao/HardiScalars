 ...
 *  
 * This executable computes Geodesic Concentration of RSH functions at 500 equally spaced
...
typedef itk::Functor::GeodesicConcentration< RshPixelType, PeakPixelType, OutputPixelType >             CalcType;
...
CalcType gcCalc; 
PeakPixelType dir;
CalcType::OutputPixelType outputGC[arrayLength];
...
{ 
  ...
  //std::cout << dir << "\n";
  outputGC[i] = gcCalc(shCoefs[3], dir);
  //std::cout << outputGC[i] << "\n";  
}
...
//angles ConvertSphereCoords(ComponentType x, ComponentType y, ComponentType z)
//{
//   angles temp; 
//   if( ( z == 1) || ( z == -1) ) //if you're at a pole
//   {
//       temp.theta = 0;
//       temp.phi    = vcl_atan(y , x);
//   }
//   else 
//   {
//       temp.theta  = vcl_acos( z );
//       temp.phi    = vcl_atan(y , x);
//   }
//     
//return temp;
